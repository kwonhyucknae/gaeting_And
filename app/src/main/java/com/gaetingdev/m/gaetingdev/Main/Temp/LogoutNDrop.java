...
import com.gaetingdev.m.gaetingdev.Main.Contents.community.Test_frag;
...
public class LogoutNDrop extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_go_fra=(Button)findViewById(R.id.btn_go_fragment);
        ...
        btn_go_fra.setOnClickListener(clickL);
        ...
        public void onClick(View v) {
            ...
            switch(v.getId()) {
                ...
                case R.id.btn_go_write_commu:
                    ...
                    finish();
                    break;
                case R.id.btn_go_fragment:
                    Intent intent4=new Intent(LogoutNDrop.this, Test_frag.class);
