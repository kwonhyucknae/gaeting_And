package com.gaetingdev.m.gaetingdev.Main.Contents.PersonalPage.PersonalMain;
...
import com.gaetingdev.m.gaetingdev.Main.Contents.PersonalPage.PageConversation.PageConversation_Main;
import com.gaetingdev.m.gaetingdev.Main.Contents.PersonalPage.PageItem.PageItem_Main;
...
public class PageFragment extends Fragment implements FragmentTabHost.OnTabChangeListener, ViewPager.OnPageChangeListener{
    ...
    /*
	  ...
	  * TAB변수 정의
	  */
    private Class[] tabclass = { PageItem_Main.class, PageConversation_Main.class };
    private String[] tabs = { PageItem_Main.class.getName(), PageConversation_Main.class.getName() };
    private String[] tab_names = { "글목록", "대화" };
